...
<h1 style="margin-left: 350px;">Periods Of Class II</h1>
</div>
<%
try {
	...
	String query="select sub_class.Period, teacher.Teacher_name, subject.Subject_name from sub_class JOIN teacher ON sub_class.Tech_ID=teacher.Tech_ID   JOIN subject ON sub_class.Sub_ID=subject.Sub_ID where class_ID=2 order by Period";
